...
| Full text | Link to the full text when available | https://www.base-search.net/about/en/faq_oai.php |
...
Some OJS instances
Crossref | https://www.base-search.net/about/en/faq.php#chap01 |
| Data collected | Metadata |  |
| Supported standard | Dublin Core | http://oai.base-search.net/ |
| User support | Mostly online documentation and FAQ : https://www.base-search.net/about/en/faq.php 
Contact form available for specific questions |  |
| Contact address for providers | https://www.base-search.net/about/en/contact.php (Webform) |  |
| Bibliodiversity support | Multilingual search
...
Reference / Citation | https://www.base-search.net/about/en/faq_oai.php#chap04 |
| Optional metadata | Other parties involved in the publication
File Format
Description
Keywords
Publisher
